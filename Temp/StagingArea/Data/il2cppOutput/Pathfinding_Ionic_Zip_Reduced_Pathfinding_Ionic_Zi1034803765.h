...
struct  EncryptionAlgorithm_t1034803765 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EncryptionAlgorithm_t1034803765, ___value___1)); }

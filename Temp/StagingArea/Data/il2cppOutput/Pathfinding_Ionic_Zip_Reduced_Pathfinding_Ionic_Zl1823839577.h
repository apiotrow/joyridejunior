...
struct  CompressionLevel_t1823839577 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CompressionLevel_t1823839577, ___value___1)); }

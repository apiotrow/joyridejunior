...
struct SubMeshInstanceU5BU5D_t767966807  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) SubMeshInstance_t3608034274  m_Items[1];

public:
	inline SubMeshInstance_t3608034274  GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline SubMeshInstance_t3608034274 * GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, SubMeshInstance_t3608034274  value)
	{
		m_Items[index] = value;
	}
};

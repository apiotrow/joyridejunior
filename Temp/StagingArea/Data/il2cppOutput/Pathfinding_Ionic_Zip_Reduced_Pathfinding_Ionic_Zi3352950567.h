...
struct  ExtractExistingFileAction_t3352950567 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ExtractExistingFileAction_t3352950567, ___value___1)); }

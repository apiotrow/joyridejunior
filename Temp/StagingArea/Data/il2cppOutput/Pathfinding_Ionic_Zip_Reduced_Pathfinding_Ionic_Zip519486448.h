...
struct  CompressionMethod_t519486448 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CompressionMethod_t519486448, ___value___1)); }

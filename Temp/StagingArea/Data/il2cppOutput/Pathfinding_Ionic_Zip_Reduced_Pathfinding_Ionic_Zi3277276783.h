...
struct  ZipProgressEventType_t3277276783 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ZipProgressEventType_t3277276783, ___value___1)); }
